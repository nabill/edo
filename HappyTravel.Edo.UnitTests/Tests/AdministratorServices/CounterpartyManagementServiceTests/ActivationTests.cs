...
namespace HappyTravel.Edo.UnitTests.Tests.AdministratorServices.CounterpartyManagementServiceTests
{
    public class ActivationTests
    {
        ...
        [Fact]
        public async Task Activation_of_active_counterparty_should_fail()
        {
        ...
        [Fact]
        public async Task Activation_of_counterparty_should_activate_agencies()
        {
            var context = _mockCreationHelper.GetContextMock().Object;
            var counterpartyManagementService = _mockCreationHelper.GetCounterpartyManagementService(context);
        ...
        [Fact]
        public async Task Activation_of_active_agency_should_fail()
        {
            var context = _mockCreationHelper.GetContextMock().Object;
            var counterpartyManagementService = _mockCreationHelper.GetCounterpartyManagementService(context);

            var (_, isFailure, error) = await counterpartyManagementService.ActivateAgency(1, "Test reason");
        ...
        public async Task Activation_of_not_existing_agency_should_fail()
        {
            ...
            var (_, isFailure, error) = await counterpartyManagementService.ActivateAgency(105, "Test reason");
        ...
        public async Task Activation_of_agency_with_empty_reason_should_fail()
        {
            ...
            var (_, isFailure, error) = await counterpartyManagementService.ActivateAgency(3, null);
        ...
        [Fact]
        public async Task Activation_of_default_agency_should_activate_counterparty()
        {
            var context = _mockCreationHelper.GetContextMock().Object;
            var counterpartyManagementService = _mockCreationHelper.GetCounterpartyManagementService(context);
