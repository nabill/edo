...
namespace HappyTravel.Edo.UnitTests.Tests.Services.Agents.PermissionCheckerTests
{
    public class PermissionCheckerTests
    {
        ...
        private static readonly AgentContext AffiliatedAgent = AgentContextFactory.CreateWithAgency(1, 1);
        private static readonly AgentContext NotAffiliatedAgent = AgentContextFactory.CreateWithAgency(100, 100);
