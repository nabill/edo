...
namespace HappyTravel.Edo.UnitTests.Tests.Services.Agents.AgentService
{
    public class AgentServiceTests
    {
        public AgentServiceTests(Mock<EdoContext> edoContextMock)
        {
            ...
            _agentService = new Api.Services.Agents.AgentService(edoContextMock.Object, new DefaultDateTimeProvider(),
        ...
        private readonly Api.Services.Agents.AgentService _agentService;
    }
}
