...
namespace HappyTravel.Edo.UnitTests.Tests.Services.Agents.AgentPermissionManagementService
{
    public class AgentPermissionManagementServiceTests
    {
        public AgentPermissionManagementServiceTests(Mock<EdoContext> edoContextMock)
        {
            ...
            _agentPermissionManagementService = new Api.Services.Agents.AgentPermissionManagementService(edoContextMock.Object,
        ...
        private readonly Api.Services.Agents.AgentPermissionManagementService _agentPermissionManagementService;
