...
namespace HappyTravel.Edo.UnitTests.Tests.Services.Payments.External.PaymentLinks.PaymentLinksProcessingService
{
    public class SignatureCalculation
    {
        ...
        private Api.Services.Payments.External.PaymentLinks.PaymentLinksProcessingService CreateProcessingService()
            => new Api.Services.Payments.External.PaymentLinks.PaymentLinksProcessingService(Mock.Of<IPayfortService>(),
