...
namespace HappyTravel.Edo.UnitTests.Tests.Services.Payments.External.PaymentLinks.PaymentLinksProcessingService
{
    public class PaymentProcess
    {
        ...
        {
            var processingService = new Api.Services.Payments.External.PaymentLinks.PaymentLinksProcessingService(CreatMockPayfortService(),
        ...
        public async Task Should_store_successful_callback_result()
        {
            ...
            Api.Services.Payments.External.PaymentLinks.PaymentLinksProcessingService CreateProcessingServiceWithProcess()
            {
                ...
                var paymentLinksProcessingService = new Api.Services.Payments.External.PaymentLinks.PaymentLinksProcessingService(
        ...
        public async Task Should_send_confirmation_on_successful_payment()
        {
            ...
            static Api.Services.Payments.External.PaymentLinks.PaymentLinksProcessingService CreateProcessingServiceWithSuccessfulPay(Mock<IPaymentLinkNotificationService> notificationServiceMock)
            {
                var service = new Mock<IPayfortService>();
                service.Setup(p => p.Pay(It.IsAny<CreditCardPaymentRequest>()))
        ...
        public async Task Should_store_successful_payment_result()
        {
            ...
            Api.Services.Payments.External.PaymentLinks.PaymentLinksProcessingService CreateProcessingServiceWithSuccessfulPay()
            {
                var service = new Mock<IPayfortService>();
                service.Setup(p => p.Pay(It.IsAny<CreditCardPaymentRequest>()))
