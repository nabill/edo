...
namespace HappyTravel.Edo.UnitTests.Tests.Services.Payments.External.PaymentLinks.PaymentLinksStorage
{
    public class GettingLinkData
    {
        public GettingLinkData(Mock<EdoContext> edoContextMock, IDateTimeProvider dateTimeProvider,
            ILogger<Api.Services.Payments.External.PaymentLinks.PaymentLinkService> logger)
        {
            ...
            _linkStorage = new Api.Services.Payments.External.PaymentLinks.PaymentLinksStorage(edoContextMock.Object,
                dateTimeProvider,
                emptyOptions,
        ...
        private readonly Api.Services.Payments.External.PaymentLinks.PaymentLinksStorage _linkStorage;
    }
}