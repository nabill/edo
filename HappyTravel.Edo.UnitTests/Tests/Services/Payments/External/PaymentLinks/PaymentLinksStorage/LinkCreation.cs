...
namespace HappyTravel.Edo.UnitTests.Tests.Services.Payments.External.PaymentLinks.PaymentLinksStorage
{
    public class LinkCreation
    {
        ...
        private Api.Services.Payments.External.PaymentLinks.PaymentLinksStorage CreateService(IOptions<PaymentLinkOptions> options = null,
            ITagProcessor tagProcessor = null)
        {
            options ??= GetValidOptions();
            tagProcessor ??= Mock.Of<ITagProcessor>();

            return new Api.Services.Payments.External.PaymentLinks.PaymentLinksStorage(_edoContextMock.Object,
