...
namespace HappyTravel.Edo.UnitTests.Tests.Services.Payments.External.PaymentLinks.PaymentLinkService
{
    public class LinkSending
    {
        ...
        private Api.Services.Payments.External.PaymentLinks.PaymentLinkService CreateService(IOptions<PaymentLinkOptions> options = null,
            ...
            IPaymentLinksStorage storage = null)
        {
            ...
            return new Api.Services.Payments.External.PaymentLinks.PaymentLinkService(options,
                notificationService,
                storage,
                new NullLogger<Api.Services.Payments.External.PaymentLinks.PaymentLinkService>());
