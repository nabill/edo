...
namespace HappyTravel.Edo.UnitTests.Tests.Services.Payments.Payfort.PayfortSignatureService
{
    public class SignatureCalculation
    {
        public SignatureCalculation()
        {
            ...
            _signatureService = new Api.Services.Payments.Payfort.PayfortSignatureService(optionsMock.Object);
        }
