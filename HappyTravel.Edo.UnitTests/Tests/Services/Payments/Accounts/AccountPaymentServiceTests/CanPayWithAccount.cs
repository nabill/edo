    ...
    public class CanPayWithAccount
    {
        public CanPayWithAccount()
        {
            ...
            _accountPaymentService = new AccountPaymentService(Mock.Of<IAccountPaymentProcessingService>(), edoContextMock.Object,
                dateTimeProvider, Mock.Of<BalanceManagementNotificationsService>());
        ...
        private readonly AgentContext _validAgentContext = AgentContextFactory.CreateWithCounterpartyAndAgency(1, 1, 1);
        private readonly AgentContext _invalidAgentContext = AgentContextFactory.CreateWithCounterpartyAndAgency(2, 2, 2);
        private readonly AgentContext _validAgentContextWithPositiveBalance = AgentContextFactory.CreateWithCounterpartyAndAgency(3, 3, 3);
