...
namespace HappyTravel.Edo.UnitTests.Tests.Services.Payments.Accounts.AccountPaymentService
{
    public class CanPayWithAccount
    {
        public CanPayWithAccount(Mock<EdoContext> edoContextMock, IDateTimeProvider dateTimeProvider)
        {
            _accountPaymentService = new Api.Services.Payments.Accounts.AccountPaymentService(Mock.Of<IAccountPaymentProcessingService>(), edoContextMock.Object,
