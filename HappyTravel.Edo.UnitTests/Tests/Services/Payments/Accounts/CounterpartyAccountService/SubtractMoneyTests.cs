...
namespace HappyTravel.Edo.UnitTests.Tests.Services.Payments.Accounts.CounterpartyAccountService
{
    public class SubtractMoneyTests
    {
        public SubtractMoneyTests(Mock<EdoContext> edoContextMock)
        {
            ...
            _counterpartyAccountService = new Api.Services.Payments.Accounts.CounterpartyAccountService(_mockedEdoContext, entityLockerMock.Object, Mock.Of<IAccountBalanceAuditService>());
