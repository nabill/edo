...
namespace HappyTravel.Edo.UnitTests.Tests.Services.Accommodations.Availability.AvailabilityStorageTests
{
    public class WideAvailabilitySearchStateCalculation
    {
        ...
        public void Search_state_should_contain_all_errors()
        {
            ...
            var supplierStates = new List<(string, SupplierAvailabilitySearchState)>
            {
                ("supplier1", SupplierAvailabilitySearchState.Failed(searchId, errors[0])),
                ("supplier2", SupplierAvailabilitySearchState.Failed(searchId, errors[1])),
                ("supplier3", SupplierAvailabilitySearchState.Failed(searchId, errors[2]))
            };
        ...
        public void Provider_search_results_count_should_sum()
        {
            ...
            var supplierStates = new List<(string, SupplierAvailabilitySearchState)>
            {
                ("supplier1", SupplierAvailabilitySearchState.Completed(searchId, new List<string>(),  10)),
                ("supplier2", SupplierAvailabilitySearchState.Completed(searchId, new List<string>(),15)),
                ("supplier3", SupplierAvailabilitySearchState.Completed(searchId, new List<string>(),144))
            };
        ...
        public void Provider_search_results_with_duplicates_should_sum_unique_results_count()
        {
            ...
            var supplierStates = new List<(string, SupplierAvailabilitySearchState)>
            {
                ("supplier1", SupplierAvailabilitySearchState.Completed(searchId, new List<string?>{"1", "2", "6", null},  10)),
                ("supplier2", SupplierAvailabilitySearchState.Completed(searchId, new List<string?>{"1", "3", null},15)),
                ("supplier3", SupplierAvailabilitySearchState.Completed(searchId, new List<string?>{"1", "4", "6"},144))
            };
        ...
        [Theory]
        [InlineData("supplier1", AvailabilitySearchTaskState.Completed)]
        [InlineData("supplier2", AvailabilitySearchTaskState.Failed)]
        [InlineData("supplier3", AvailabilitySearchTaskState.Pending)]
        public void One_supplier_search_should_return_supplier_state(string supplierCode, AvailabilitySearchTaskState supplierTaskState)
        {
            ...
            var wideSearchState = WideAvailabilitySearchState.FromSupplierStates(searchId, new[] {(supplierCode, supplierSearchState: supplierSearchState)});
        ...
        public void Should_return_same_state_when_supplier_states_equal(AvailabilitySearchTaskState searchTaskState)
        {
            ...
            var supplierSearchStates = new List<(string, SupplierAvailabilitySearchState)>
            {
                ("supplier1", CreateSupplierAvailabilitySearchState(searchId, searchTaskState)),
                ("supplier2", CreateSupplierAvailabilitySearchState(searchId, searchTaskState)),
                ("supplier3", CreateSupplierAvailabilitySearchState(searchId, searchTaskState))
            };
        ...
        public void Should_return_completed_when_all_searches_finished_or_failed()
        {
            ...
            var supplierSearchStates = new List<(string, SupplierAvailabilitySearchState)>
            {
                ("supplier1", CreateSupplierAvailabilitySearchState(searchId, AvailabilitySearchTaskState.Completed)),
                ("supplier2", CreateSupplierAvailabilitySearchState(searchId, AvailabilitySearchTaskState.Failed)),
                ("supplier3", CreateSupplierAvailabilitySearchState(searchId, AvailabilitySearchTaskState.Failed))
            };
        ...
        public void Should_return_partially_completed_when_one_connector_is_pending()
        {
            ...
            {
                ("supplier1", CreateSupplierAvailabilitySearchState(searchId, AvailabilitySearchTaskState.Completed)),
                ("supplier2", CreateSupplierAvailabilitySearchState(searchId, AvailabilitySearchTaskState.Pending)),
                ("supplier3", CreateSupplierAvailabilitySearchState(searchId, AvailabilitySearchTaskState.Failed))
            };
