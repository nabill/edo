...
namespace HappyTravel.Edo.UnitTests.Tests.Services.Accommodations.Bookings.BookingsProcessingService.Cancellation
{
    public class ExecutingCancellation
    {
        ...
        private Api.Services.Accommodations.Bookings.BookingsProcessingService CreateProcessingService(IBookingService bookingService)
        {
