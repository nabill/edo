...
namespace HappyTravel.Edo.UnitTests.Tests.Services.Accommodations.Bookings.BookingsProcessingService.Cancellation
{
    public class GettingForCancellation
    {
        ...
        private static Api.Services.Accommodations.Bookings.BookingsProcessingService CreateProcessingService()
        {
            ...
            return new Api.Services.Accommodations.Bookings.BookingsProcessingService(Mock.Of<IBookingPaymentService>(),
