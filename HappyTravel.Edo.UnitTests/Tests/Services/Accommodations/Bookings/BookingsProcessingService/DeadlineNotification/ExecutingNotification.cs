...
namespace HappyTravel.Edo.UnitTests.Tests.Services.Accommodations.Bookings.BookingsProcessingService.DeadlineNotification
{
    public class ExecutingNotification
    {
        ...
        private Api.Services.Accommodations.Bookings.BookingsProcessingService CreateProcessingService(IBookingMailingService mailingService)
        {
            ...
            var service = new Api.Services.Accommodations.Bookings.BookingsProcessingService(Mock.Of<IBookingPaymentService>(),
