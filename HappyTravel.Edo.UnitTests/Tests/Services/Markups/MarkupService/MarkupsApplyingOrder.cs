...
namespace HappyTravel.Edo.UnitTests.Tests.Services.Markups.MarkupService
{
    public class MarkupsApplyingOrder
    {
        public MarkupsApplyingOrder(Mock<EdoContext> edoContextMock, IMemoryFlow memoryFlow)
        {
            ...
            _markupService = new Api.Services.Markups.MarkupService(edoContextMock.Object,
                memoryFlow,
        ...
        private readonly Api.Services.Markups.MarkupService _markupService;
    }
}