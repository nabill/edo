...
namespace HappyTravel.Edo.Data.Migrations
{
    public partial class RankForPredictionsSearch : Migration
    {
        ...
        {
            var alterSearchLocationRankFunction = @"
            ...
            migrationBuilder.Sql(alterSearchLocationRankFunction);
            ...
            var createIndexGetLocationConcatenatedTsVector = "CREATE INDEX IF NOT EXISTS \"IDX_GetLocationConcatenatedTsVector\" ON \"Locations\" USING gin(get_location_concatenated_tsvector(\"Locality\", \"Name\", \"Country\"))";
