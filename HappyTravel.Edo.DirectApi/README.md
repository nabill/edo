...
|-----|-----|
| Generated by HappyTravel.com | Generated by the client |
...
| Status | Description |
|-------|-------------|
| Created | Registered in the HappyTravel.com system but not yet finalized. |
...
| ManualCorrectionNeeded | Booking details do not match between the data sources for HappyTravel.com and the supplier. Our reservation team investigates all bookings with this status. |
