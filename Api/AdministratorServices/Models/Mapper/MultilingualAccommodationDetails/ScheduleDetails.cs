...
public record ScheduleDetails
{
    ...
    public string PortersStartTime { get; init; }
    public string PortersEndTime { get; init; }
    public string RoomServiceStartTime { get; init; }
    public string RoomServiceEndTime { get; init; }
}