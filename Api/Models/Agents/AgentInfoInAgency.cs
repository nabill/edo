...
namespace HappyTravel.Edo.Api.Models.Agents
{
    ...
    public readonly struct AgentInfoInAgency
    {
        public AgentInfoInAgency(int agentId, string firstName, string lastName, string email,
            ...
            bool isMaster, List<InAgencyPermissions> inAgencyPermissions, List<string> inAgencyRoles, bool isActive)
        {
            AgentId = agentId;
            FirstName = firstName;
            LastName = lastName;
        ...
        ///     Roles of the agent.
        /// </summary>
        public List<string> InAgencyRoles { get; }
