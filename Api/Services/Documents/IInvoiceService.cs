...
namespace HappyTravel.Edo.Api.Services.Documents
{
    public interface IInvoiceService
    {
        ...
        Task<List<(DocumentRegistrationInfo Metadata, TInvoiceData Data)>> Get<TInvoiceData>(ServiceTypes serviceType, ServiceSource serviceSource, string referenceCode);
    }
}