...
namespace HappyTravel.Edo.Api.Services.Accommodations.Availability.Mapping
{
    public interface IAccommodationMapperClient
    {
        ...
        Task<Result<Accommodation, ProblemDetails>> GetAccommodation(int supplier, string accommodationId, string languageCode, CancellationToken cancellationToken = default);
