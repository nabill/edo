...
namespace HappyTravel.Edo.Api.Services.Accommodations.Availability.Steps.WideAvailabilitySearch
{
    public readonly struct WideAvailabilitySearchState
    {
        ...
        public static WideAvailabilitySearchState FromProviderStates(Guid searchId, IEnumerable<(Suppliers, ProviderAvailabilitySearchState)> searchStates)
        {
            ...
            static AvailabilitySearchTaskState CalculateOverallState(Dictionary<Suppliers, ProviderAvailabilitySearchState> providerSearchStates)
            {
            ...
            static string GetErrors(Dictionary<Suppliers, ProviderAvailabilitySearchState> states)
            {
                var errors = states
            ...
            static int GetResultsCount(Dictionary<Suppliers, ProviderAvailabilitySearchState> states)
            {
