...
namespace HappyTravel.Edo.Api.Services.Payments.Accounts
{
    public class AccountPaymentProcessingService : IAccountPaymentProcessingService
    {
        ...
        public async Task<Result> AuthorizeMoney(int accountId, AuthorizedMoneyData paymentData, UserInfo user)
        {
            ...
            bool IsBalancePositive(PaymentAccount account) => (account.Balance).IsGreaterThan(decimal.Zero);
        ...
        private bool IsBalanceSufficient(PaymentAccount account, decimal amount) => (account.Balance).IsGreaterOrEqualThan(amount);
