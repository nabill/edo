...
namespace HappyTravel.Edo.Api.Services.Markups
{
    public interface IMarkupService
    {
        ...
        /// <param name="destinationInfo">To what markup is applied. E.g. accommodation</param>
        ...
        Task<TDetails> ApplyMarkups<TDetails>(MarkupSubjectInfo subject, MarkupDestinationInfo destinationInfo, TDetails details,
