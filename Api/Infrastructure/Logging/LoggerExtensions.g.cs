...
namespace HappyTravel.Edo.Api.Infrastructure.Logging
{
    public static class LoggerExtensions
    {
        static LoggerExtensions()
        {
            ...
            FoundCachedResults = LoggerMessage.Define<string, System.Guid>(LogLevel.Information,
                new EventId(1146, "FoundCachedResults"),
                "Found cached results for supplier '{Supplier}' and searchId '{SearchId}'");
            ...
            ConnectorClientDelay = LoggerMessage.Define<double, string, int>(LogLevel.Warning,
                new EventId(1140, "ConnectorClientDelay"),
                "Delaying connector client for {Delay}ms: '{Message}', then making retry {Retry}");
            
            ConnectorRequestFailedOnSecondStep = LoggerMessage.Define<string>(LogLevel.Warning,
                new EventId(1141, "ConnectorRequestFailedOnSecondStep"),
                "{Message}");
            
            ConnectorResultsWereRefreshed = LoggerMessage.Define<string>(LogLevel.Information,
                new EventId(1142, "ConnectorResultsWereRefreshed"),
                "Results for connector '{Connector}' were successfully refreshed");
         ...
         public static void LogFoundCachedResults(this ILogger logger, string Supplier, System.Guid SearchId, Exception exception = null)
            => FoundCachedResults(logger, Supplier, SearchId, exception);
         ...
         public static void LogConnectorClientDelay(this ILogger logger, double Delay, string Message, int Retry, Exception exception = null)
            => ConnectorClientDelay(logger, Delay, Message, Retry, exception);
                
         public static void LogConnectorRequestFailedOnSecondStep(this ILogger logger, string Message, Exception exception = null)
            => ConnectorRequestFailedOnSecondStep(logger, Message, exception);
                
         public static void LogConnectorResultsWereRefreshed(this ILogger logger, string Connector, Exception exception = null)
            => ConnectorResultsWereRefreshed(logger, Connector, exception);
        ...
        private static readonly Action<ILogger, string, System.Guid, Exception> FoundCachedResults;
        ...
        private static readonly Action<ILogger, double, string, int, Exception> ConnectorClientDelay;
        
        private static readonly Action<ILogger, string, Exception> ConnectorRequestFailedOnSecondStep;
        
        private static readonly Action<ILogger, string, Exception> ConnectorResultsWereRefreshed;
    }
}