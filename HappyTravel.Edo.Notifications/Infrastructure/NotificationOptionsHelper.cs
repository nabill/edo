...
namespace HappyTravel.Edo.Notifications.Infrastructure
{
    public static class NotificationOptionsHelper
    {
        ...
        private static readonly Dictionary<NotificationTypes, SlimNotificationOptions> _defaultOptions = new()
        {
            ...
            // Administrator
            [NotificationTypes.MasterCustomerInvitation] = new() { EnabledProtocols = ProtocolTypes.Email, IsMandatory = true },
            [NotificationTypes.MasterCustomerSuccessfulRegistration] = new() { EnabledProtocols = ProtocolTypes.Email | ProtocolTypes.WebSocket, IsMandatory = true },
